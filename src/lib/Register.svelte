...
<div class="container">
    <div class="card card-container">
        ...
        <form class="form-signin" on:submit|preventDefault={registrar}>
            ...
            <input type="text" id="inputNome" class="form-control" bind:value={nome} placeholder="Nome" required autofocus>
            <input type="text" id="inputSobrenome" class="form-control" bind:value={sobrenome} placeholder="Sobrenome" required>
            <input type="text" id="inputDataNasc" class="form-control" bind:value={datanasc} placeholder="Data de Nascimento" required>
            <input type="text" id="inputCPF" class="form-control" bind:value={cpf} placeholder="CPF" required>
...
.form-signin #inputSobrenome,
.form-signin #inputDataNasc,
.form-signin #inputCPF,
